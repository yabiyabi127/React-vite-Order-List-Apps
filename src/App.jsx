...
import { INITIAL_FILTER, TABS } from "../src/constants/filters";
...
function App() {
  ...
  const fetchOrdersPage = async ({ pageParam = 1 }) => {
    ...
    const newTabs = TABS.map(tab => ({
      ...tab,
      count: response.data.summary_do[tab.value].total
    }));
  ...
  return (
    <div className="p-16 bg-[#111827]" ref={containerRef} style={{ height: "100vh", overflowY: "auto" }}>
      <Tabs 
       tabs={tabsWithCount} 
